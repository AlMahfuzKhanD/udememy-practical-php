		...
		<div class="wrapper">
			...
			<div class="sandbox">
                ...
                if($favouriteStringNum === 1){
                    echo "<p>Your favourit number is an integer</p>";
                }else if ($favouriteStringNum === "1"){
                    echo "<p>Your favourit number is string</p>";
                }else{
                    echo "<p>you must have a different number than 1 integer or string</p>";
                }
				?>
                ...
                if($birthCountry != "Mexico"){
                    echo "<p>Your ar not a maxican</p>";
                }
				?>
