	...
	<body>
		<div class="wrapper">
			...
			<div class="sandbox">
                ...
                <p><strong><?php echo $gentlemen[0]["first_name"];?></strong> is quite the <strong><?php echo $age_group[2];?></strong>!! He sports a solid <strong><?php echo $handlebar["name"];?></strong> Moustache that is <strong><?php echo $handlebar["colour"]?></strong> and colour.</p>

                <h3><?php echo $gentlemen[1]["first_name"];?> from <?php echo $gentlemen[1]["country"];?> </h3>
                <p><strong><?php echo $gentlemen[1]["first_name"];?></strong> is a rather dapper <strong><?php echo $age_group[1];?></strong>!! He proudly wears  a <strong><?php echo $fu_manchu["name"];?></strong> that is coloured a gentle <strong><?php echo $fu_manchu["colour"]?></strong> and colour.</p>
